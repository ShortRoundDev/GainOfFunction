...
#define COLLIDEABLE(x) ((x) != NULL && (!WALL_IS_DOOR((x)) ^ ((x)->isDoor && !(x)->isOpen)))
#define COLLIDEABLE_ALL(x) (!WALL_IS_KIND((x), BLANK_WALL) && !WALL_IS_KIND((x), WALL_SIGN) && !WALL_IS_KIND((x), TV_SCREEN) && COLLIDEABLE((x)))